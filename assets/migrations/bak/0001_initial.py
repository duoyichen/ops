    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('network_device', '网络设备'), ('server_device', '服务器设备'), ('o_device', '其他设备')], default='network_asset', max_length=64, verbose_name='资产类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, '交换机'), (1, '路由器'), (2, 'VPN设备'), (4, '防火墙')], default=0, verbose_name='网络设备类型')),
                ...
                ('device_detail', models.TextField(blank=True, null=True, verbose_name='设备配置')),
                ('device_log', models.TextField(blank=True, null=True, verbose_name='设备日志')),
